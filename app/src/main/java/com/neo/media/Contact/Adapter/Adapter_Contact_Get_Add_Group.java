...
public class Adapter_Contact_Get_Add_Group extends RecyclerView.Adapter<Adapter_Contact_Get_Add_Group.TopicViewHoder> {
    ...
    public Adapter_Contact_Get_Add_Group(List<PhoneContactModel> listTopic, Context context) {
