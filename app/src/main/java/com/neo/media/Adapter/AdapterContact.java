...
public class AdapterContact extends RecyclerView.Adapter<AdapterContact.TopicViewHoder>{
    ...
    public AdapterContact(List<PhoneContactModel> listTopic, Context context) {
