package com.neo.ringtunesgo.Fragment;
...
import com.neo.ringtunesgo.Fragment.InfoUser.InfoUserInterface;
import com.neo.ringtunesgo.Fragment.InfoUser.PresenterInfoUser;
                    ...
                    switch (keyCode) {
                        ...
                        case KeyEvent.KEYCODE_ENTER:
                            if (ecFullName.getText().toString().length() > 0 && editTextBirthday.getText().toString().length() > 0) {
                                presenterInfoUser.update_profile(ecFullName.getText().toString(), msisdn, "",
    ...
    public void getData(Info_User objInfo) {
        if (objInfo != null) {
            if (objInfo.getRegister_date() != null && objInfo.getRegister_date().length() > 0) {
                String date = objInfo.getRegister_date();
                String[] arrdate = date.split("-");
                date = arrdate[2] + "/" + arrdate[1] + "/" + arrdate[0];
                txt_date_info.setText("Ngày đăng ký: " + date);
            }
